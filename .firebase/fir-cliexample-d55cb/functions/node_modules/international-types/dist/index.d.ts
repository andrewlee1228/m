...
type ExtractScopes<Value extends string, Prev extends string | undefined = undefined> = Value extends `${infer Head}.${infer Tail}` ? [
...
type SomeKey<T extends Record<string, any>> = UnionToTuple<keyof T>[0] extends string ? UnionToTuple<keyof T>[0] : never;
